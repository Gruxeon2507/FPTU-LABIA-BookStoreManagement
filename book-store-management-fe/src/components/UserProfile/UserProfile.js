        ...
        <div className="profile-container">
            <div className="user-info">
                <div className="avatar-card">
                    <img src={`http://103.173.229.92:6789/api/users/avatar/${user.username}.jpg`} alt={user.username} />
                    {console.log(`http://103.173.229.92:6789/api/users/avatar/${user.username}.jpg`)}
